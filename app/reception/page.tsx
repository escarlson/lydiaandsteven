    ...
    <div>
      <main className="pt-5">
        <div className="container mt-5">
          ...
          <h2>Drinks</h2>
          <p> There will be two hosted bars (one inside, one outside) and guests may receive two drinks (wine, beer, draft cocktails, and margaritas) on the house. Additional drinks or fancy-shmancy cocktails can be purchased if desired. Bring your ID.</p>
          ...
          <h2>Parking</h2>
          <p>Parking is behind the brewery, with street entrance off of Agua Fria St. Once you park, enter the venue through the back patio.</p>
        </div>
      </main>
    </div>
  );
